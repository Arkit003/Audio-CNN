...
interface RawApiResponse {
  predictions?: Prediction[];
  visualization?: VisualizationData;
  visulization?: VisualizationData;
  input_spectrogram?: LayerData;
...
function normalizeApiResponse(data: RawApiResponse): ApiResponse {
  const visualization = data.visualization ?? data.visulization;
  const inputSpectrogram = data.input_spectrogram ?? data.input_spectogram;
  ...
  return {
    ...
    visualization,
    input_spectrogram: inputSpectrogram,
...
export default function HomePage() {
  ...
  const handleFileChange = async (
    ...
    reader.onload = async () => {
      try {
        ...
        setVizData(normalizeApiResponse(data));
      } catch (err) {
        setError(
  ...
  const { main, internals } = splitLayers(vizData?.visualization ?? {});
